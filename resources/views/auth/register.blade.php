<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <x-jet-validation-errors class="mb-4" />
         <div class="mt-4">
             Account Creation for customers  on Complaint Portal
         </div>
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
             ...
             <div>
                ...
                <x-jet-input id="last_name" class="block mt-1 w-full" type="text" name="last_name" :value="old('last_name')" required autofocus autocomplete="lasst_ame" />
            </div>
            ...
            <div class="mt-4">
             ...
             <div>
                <x-jet-label for="city" value="{{ __('Branch') }}" />
                <x-jet-input id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city')" required autofocus autocomplete="branch" />
            </div>
             <div>
